...
PreparedStatement ps=con.prepareStatement("select country_name from "+table+" where Type='VFL' and `Dpmt.`='SERD'");
PreparedStatement ps2=con.prepareStatement("select country_name from "+table+" where Type='AF' and `Dpmt.`='SERD'");
ResultSet rs,rs2;
rs = ps.executeQuery();
...
ps=con.prepareStatement("select country_name from "+table+" where Type='VFL' and `Dpmt.`='SET'");
ps2=con.prepareStatement("select country_name from "+table+" where Type='AF' and `Dpmt.`='SET'");
rs = ps.executeQuery();
rs2=ps2.executeQuery();
...
ps=con.prepareStatement("select country_name from "+table+" where Type='VFL' and `Dpmt.`='SOM'");
ps2=con.prepareStatement("select country_name from "+table+" where Type='AF' and `Dpmt.`='SOM'");
rs = ps.executeQuery();
rs2=ps2.executeQuery();
...
%>
<h2>Visiting faculty < 1yr and Adjunct Faculty Report </h2>
<table>
    <tr>
        <td></td>
        <td><b>SERD</b></td>
