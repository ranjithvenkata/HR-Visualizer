...
%>
    ...
    <%
        ...
        dataset.setValue("Full-time Faculty",ffsom);
        dataset.setValue("More Year Faculty",vfmsom);
        dataset.setValue("Less Year Faculty",vflsom);
        dataset.setValue("Adjunct Faculty",afsom);
